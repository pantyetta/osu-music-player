...
namespace OsuMusicPlayer
{
    ...
    public partial class App : Application
    {
        ...
        public static bool ListSelect_suppress = false;
        ...
        {
            var songmodel = new SongsModel();
            var db = new Database();
            songmodel.AppendSong(db.get_Songs());
        }

        private async void InitOsuPath()
        {
            StorageFolder folder = await CheckFoler("OsuFolderToken");
            Settings.OsuPath = folder?.Path ?? "";
        }
    ...
    public class INIT
    {
        ...
        public static double VOLUME_RATE = 0.0005;
    }
}
